...
/**
 * Spring Data JPA repository for entity "Casefan" <br>
 *
...
public interface CasefanRepository extends JpaRepository<Casefan, Integer> {
    ...
    // List<Casefan> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Casefan> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Casefan> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Casefan> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
