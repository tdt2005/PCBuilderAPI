...
/**
 * Spring Data JPA repository for entity "Ups" <br>
 *
...
public interface UpsRepository extends JpaRepository<Ups, Integer> {
    ...
    // List<Ups> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Ups> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Ups> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Ups> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
