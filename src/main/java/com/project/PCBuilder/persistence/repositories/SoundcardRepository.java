...
/**
 * Spring Data JPA repository for entity "Soundcard" <br>
 *
...
public interface SoundcardRepository extends JpaRepository<Soundcard, Integer> {
    ...
    // List<Soundcard> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Soundcard> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Soundcard> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Soundcard> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
