...
/**
 * Spring Data JPA repository for entity "Videocard" <br>
 *
...
public interface VideocardRepository extends JpaRepository<Videocard, Integer> {
    ...
    // List<Videocard> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Videocard> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Videocard> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Videocard> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
