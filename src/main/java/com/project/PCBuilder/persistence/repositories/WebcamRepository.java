...
/**
 * Spring Data JPA repository for entity "Webcam" <br>
 *
...
public interface WebcamRepository extends JpaRepository<Webcam, Integer> {
    ...
    // List<Webcam> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Webcam> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Webcam> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Webcam> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
