...
/**
 * Spring Data JPA repository for entity "Opticaldrive" <br>
 *
...
public interface OpticaldriveRepository extends JpaRepository<Opticaldrive, Integer> {
    ...
    // List<Opticaldrive> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Opticaldrive> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Opticaldrive> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Opticaldrive> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
