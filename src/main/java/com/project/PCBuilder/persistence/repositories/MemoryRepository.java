...
/**
 * Spring Data JPA repository for entity "Memory" <br>
 *
...
public interface MemoryRepository extends JpaRepository<Memory, Integer> {
    ...
    // List<Memory> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Memory> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Memory> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Memory> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
