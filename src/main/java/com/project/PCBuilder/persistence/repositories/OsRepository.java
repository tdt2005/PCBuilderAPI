...
/**
 * Spring Data JPA repository for entity "Os" <br>
 *
...
public interface OsRepository extends JpaRepository<Os, Integer> {
    ...
    // List<Os> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Os> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Os> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Os> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
