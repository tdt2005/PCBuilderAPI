...
/**
 * Spring Data JPA repository for entity "Thermalpaste" <br>
 *
...
public interface ThermalpasteRepository extends JpaRepository<Thermalpaste, Integer> {
    ...
    // List<Thermalpaste> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Thermalpaste> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Thermalpaste> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Thermalpaste> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
