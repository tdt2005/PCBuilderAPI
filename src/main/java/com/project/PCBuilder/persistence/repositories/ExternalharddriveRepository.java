...
/**
 * Spring Data JPA repository for entity "Externalharddrive" <br>
 *
...
public interface ExternalharddriveRepository extends JpaRepository<Externalharddrive, Integer> {
    ...
    // List<Externalharddrive> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Externalharddrive> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Externalharddrive> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Externalharddrive> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
