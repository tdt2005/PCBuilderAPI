...
/**
 * Spring Data JPA repository for entity "Components" <br>
 *
...
public interface ComponentsRepository extends JpaRepository<Components, Integer> {
    ...
    // List<Components> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Components> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Components> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Components> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
