...
public class CasefanService extends GenericService<Casefan, CasefanDTO> {
	 ...
	 */
	public CasefanService(CasefanRepository repository, PartsRepository partsRepository, EntityManager em) {
	 ...
	 */
	private void validateForeignKeyReferences(CasefanDTO dto) {
	 ...
	 */
	public List<CasefanDTO> findAll(int pageNumber, int pageSize, String searchName, BigDecimal minPrice, BigDecimal maxPrice, String sortBy, String sortDirection) {
	    logger.debug("findAll() via stored procedure with parameters");

	    StoredProcedureQuery sp = em.createStoredProcedureQuery("sp_GetCasefansWithPagination");
	    ...
	    return rows.stream().map(r -> {
	        ...
	        casefanDto.setPartid(parts.getPartid());
	        casefanDto.setParts(parts);
	        casefanDto.setSize((Integer) r[3]);
	        casefanDto.setColor((String) r[4]);
	        casefanDto.setRpm((String) r[5]);
	        casefanDto.setAirflow((String) r[6]);
	        casefanDto.setNoiseLevel((String) r[7]);
	        casefanDto.setPwm((Boolean) r[8]);
	...
	public boolean partialUpdate(Integer partid, CasefanDTO dto) {
		...
		if (optionalEntity.isPresent()) {
			...
			if (dto.getAirflow() != null) {
				entity.setAirflow(dto.getAirflow());
			}
	 ...
	 */ /*
	public List<CasefanDTO> findByParts(Integer partid) {
		logger.debug("findByParts({})", partid);
		List<Casefan> list = repository.findByPartID(partid);
