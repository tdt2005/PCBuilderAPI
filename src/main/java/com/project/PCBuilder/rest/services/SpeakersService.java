...
public class SpeakersService extends GenericService<Speakers, SpeakersDTO> {
	 ...
	 */
	public SpeakersService(SpeakersRepository repository, PartsRepository partsRepository, EntityManager em) {
	 ...
	 */
	private void validateForeignKeyReferences(SpeakersDTO dto) {
	 ...
	 */
	public List<SpeakersDTO> findAll(int pageNumber, int pageSize, String searchName, BigDecimal minPrice, BigDecimal maxPrice, String sortBy, String sortDirection) {
	    logger.debug("findAll() via stored procedure with parameters");

	    StoredProcedureQuery sp = em.createStoredProcedureQuery("sp_GetSpeakerssWithPagination");
	    ...
	    return rows.stream().map(r -> {
	        ...
	        speakersDto.setPartid(parts.getPartid());
	        speakersDto.setParts(parts);
	        speakersDto.setConfiguration((String) r[3]);
	        speakersDto.setWattage((BigDecimal) r[4]);
	        speakersDto.setFrequencyResponse((String) r[5]);
	        speakersDto.setColor((String) r[6]);
	 ...
	 */ /*
	public List<SpeakersDTO> findByParts(Integer partid) {
		logger.debug("findByParts({})", partid);
		List<Speakers> list = repository.findByPartID(partid);
