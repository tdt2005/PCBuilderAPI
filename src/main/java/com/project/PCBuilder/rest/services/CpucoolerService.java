...
public class CpucoolerService extends GenericService<Cpucooler, CpucoolerDTO> {
	 ...
	 */
	public CpucoolerService(CpucoolerRepository repository, PartsRepository partsRepository, EntityManager em) {
	 ...
	 */
	public List<CpucoolerDTO> findAll(int pageNumber, int pageSize, String searchName, BigDecimal minPrice, BigDecimal maxPrice, String sortBy, String sortDirection) {
	    logger.debug("findAll() via stored procedure with parameters");

	    StoredProcedureQuery sp = em.createStoredProcedureQuery("sp_GetCpucoolersWithPagination");
	    ...
	    return rows.stream().map(r -> {
	        ...
	        cpucoolerDto.setPartid(parts.getPartid());
	        cpucoolerDto.setParts(parts);
	        cpucoolerDto.setRpm((String) r[3]);
	        cpucoolerDto.setNoiseLevel((String) r[4]);
	        cpucoolerDto.setColor((String) r[5]);
	        cpucoolerDto.setSize((Integer) r[6]);
