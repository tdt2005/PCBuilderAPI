...
public class SoundcardService extends GenericService<Soundcard, SoundcardDTO> {
	 ...
	 */
	public SoundcardService(SoundcardRepository repository, PartsRepository partsRepository, EntityManager em) {
	 ...
	 */
	public List<SoundcardDTO> findAll(int pageNumber, int pageSize, String searchName, BigDecimal minPrice, BigDecimal maxPrice, String sortBy, String sortDirection) {
	    logger.debug("findAll() via stored procedure with parameters");

	    StoredProcedureQuery sp = em.createStoredProcedureQuery("sp_GetSoundcardsWithPagination");
	    ...
	    return rows.stream().map(r -> {
	        SoundcardDTO soundcardDto = new SoundcardDTO();
	        ...
	        soundcardDto.setPartid(parts.getPartid());
	        soundcardDto.setParts(parts);
	        soundcardDto.setChannels((String) r[3]);
	        soundcardDto.setDigitalAudio((Integer) r[4]);
	        soundcardDto.setSnr((Integer) r[5]);
	        soundcardDto.setSampleRate((BigDecimal) r[6]);
	        soundcardDto.setChipset((String) r[7]);
	        soundcardDto.setIface((String) r[8]);
